#어만사 전용 디스코드 봇 변경 테스트 ㄷㅈㅁㄹㅈ대러매쟏러매젇래ㅑㅁ젇레ㅐ먀젇래ㅔㅑㅁ젇래ㅑㅁ저댈
...
#명령어 추가는 여기에 #명령어 추가는 여기에 #명령어 추가는 여기에 #명령어 추가는 여기에 #명령어 추가는 여기에 #명령어 추가는 여기에
#메인 시스템 이후 멀티 #메인 시스템 이후 멀티 #메인 시스템 이후 멀티 #메인 시스템 이후 멀티 #메인 시스템 이후 멀티 #메인 시스템 이후 멀티
#메인 시스템 이후 멀티 #메인 시스템 이후 멀티 #메인 시스템 이후 멀티 #메인 시스템 이후 멀티 #메인 시스템 이후 멀티 #메인 시스템 이후 멀티
#명령어 추가는 여기에 #명령어 추가는 여기에 #명령어 추가는 여기에 #명령어 추가는 여기에 #명령어 추가는 여기에 #명령어 추가는 여기에
