...
async def on_message(message):
    ...
    if str(message.channel.id) == "871251097988235275":
        ...
        try:
            ...
            mallist =["겊", "귬", "깆", "껸", "꼇", "꼍", "꾜", "끠", "냑", "냔", "냘", "녘", "뇰", "뉼", "늄", "늉", "덟", "뎬", "돎", "듈", "듐", "랒", "랖", "랸", "럴", "럿", "렁", "렝", "룅", "룔", "륀", "륨", "른", "릅", "릇", "릊", "릎", "먕", "뮴", "믐", "밗", "볜", "븀", "븐", "븜", "쁨", "앝", "엌", "왑", "웤", "읓", "읔", "읕", "읖", "읗", "잌", "쭘", "찱", "캇", "콫", "쾃", "쿄", "탉", "텝", "톹", "튬", "틂", "틋", "틤", "풂", "픔", "핕", "휵", "겇", "곹", "궃", "궆", "궘", "긑", "깞", "꺠", "껱", "껼", "꽅", "꽌", "꾈", "꿑", "뀨", "낕", "넠", "녝", "녬", "놩", "뇸", "눤", "닼", "돍", "돜", "땽", "뚭", "뜹", "띱", "랓", "렃", "렄", "렆", "롕", "롶", "롹", "뢔", "뤌", "뤗", "릋", "릏", "먄", "멐", "밲", "볌", "봠", "붖", "붤", "븡", "빝", "뼌", "샄", "샆", "샡", "섳", "솣", "솦", "쇔", "숡", "숰", "싥", "싴", "썀", "쎂", "쎕", "얨", "얶", "옄", "왙", "욈", "웆", "웉", "웟", "윶", "읅", "읨", "쟤", "쟹", "젘", "짗", "캍", "컽", "쾜", "큭", "큿", "탘", "톔", "툿", "풰", "퓜", "훕", "훽"]
